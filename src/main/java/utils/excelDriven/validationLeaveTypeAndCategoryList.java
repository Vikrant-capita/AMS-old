...
public class validationLeaveTypeAndCategoryList {

	public ArrayList<String> getData1(String testcaseName, String coloumnName) throws IOException{
		...
		{
		if(workbook.getSheetName(i).equalsIgnoreCase("LeaveType"))
		{
